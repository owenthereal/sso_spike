class ApplicationController < ActionController::Base
  ...
  def client_id
    "mmhx6ugzrokogw6od2sl5k2smlbya2x"
  end

  def client_secret
    "ioruayvoxo3ffafv6iwzsik16720c6t"
  end
  ...
  def accounts_auth_url_for(path)
    "#{accounts_url}/users/#{path}?redirect_uri=#{current_url}auth/acl/callback&client_id=#{client_id}&response_type=code"
  end
